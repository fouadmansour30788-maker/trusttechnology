  ...
  return (
    <div className="flex flex-col h-[min(72vh,640px)]">
      ...
      <p className="mt-2 text-center text-xs text-slate-400 inline-flex items-center justify-center gap-1">
        <MessageCircle size={11} /> Prefer a human? <a href={`https://wa.me/9613393002?text=${encodeURIComponent('Hi Trust Technology! I have a question.')}`} target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:underline">Chat on WhatsApp</a>
      </p>
    </div>
  )
}
